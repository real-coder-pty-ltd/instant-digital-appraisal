                ...
                <div>
                    <select id="nearby-suburbs-select" class="form-select dsp-nearby-suburbs"
                        ...
                        <option value="<?= get_the_title($nearby_suburb->ID); ?>"
                            ...
                            data-drive-car="<?php echo isset($travel_distance->data[$nearby_suburb->ID]['driving']['duration']) ? $travel_distance->data[$nearby_suburb->ID]['driving']['duration'] : ''; ?>"
                            data-drive-train="<?php echo isset($travel_distance->data[$nearby_suburb->ID]['transit']['duration']) ? $travel_distance->data[$nearby_suburb->ID]['transit']['duration'] : ''; ?>"
                            data-drive-walking="<?php echo isset($travel_distance->data[$nearby_suburb->ID]['walking']['duration']) ? $travel_distance->data[$nearby_suburb->ID]['walking']['duration'] : ''; ?>"
                            data-drive-bicycle="<?php echo isset($travel_distance->data[$nearby_suburb->ID]['bicycling']['duration']) ? $travel_distance->data[$nearby_suburb->ID]['bicycling']['duration'] : ''; ?>"
                            <?= $index === 0 ? 'selected' : ''; ?>>
