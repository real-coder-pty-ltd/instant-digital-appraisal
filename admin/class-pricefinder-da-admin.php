 ...
 * @subpackage Pricefinder_Da/admin
 */
...
class Pricefinder_Da_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/pricefinder-da-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/pricefinder-da-admin.js', array( 'jquery' ), $this->version, false );
