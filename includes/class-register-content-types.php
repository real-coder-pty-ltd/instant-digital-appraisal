...
class RegisterContentTypes
{
    public function __construct()
    {
        add_action('init', [$this, 'registerAppraisal']);
        add_action('init', [$this, 'registerSuburbProfile']);
        add_action('init', [$this, 'registerPropertyProfile']);
        add_action('init', [$this, 'registerPropertyTaxonomy']);
        add_action('init', [$this, 'registerSuburbTaxonomy']);
    }

    public function registerAppraisal(): void
    {
        $labels = [
    ...
    public function registerSuburbProfile(): void
    {
        $labels = [
    ...
    public function registerPropertyProfile(): void
    {
        $labels = [
    ...
    public function registerSuburbTaxonomy(): void
    {
    ...
    public function registerPropertyTaxonomy(): void
    {
